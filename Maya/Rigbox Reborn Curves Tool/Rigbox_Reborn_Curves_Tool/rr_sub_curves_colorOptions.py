...
def gui_creation():
    ...
    pm.button(l='', w=90, bgc=(0,1,0), c=pm.Callback(rr_colorCurves_buttons, 14))
    pm.setParent(color_options)

    pm.rowColumnLayout(nc=2)
    pm.button(l='', w=90, bgc=(242.0/255.0,45.0/255.0,222.0/255.0), c=pm.Callback(rr_colorCurves_buttons, 9))
    pm.button(l='', w=90, bgc=(1,190.0/255.0,180.0/255.0), c=pm.Callback(rr_colorCurves_buttons, 20))
    pm.setParent(color_options)
